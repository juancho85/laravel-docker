...
function startEdit(event){
    ...
    //previous (back 2 elements) sibling first child
    var li = event.path[2].children[0];
    // (back 4 elements) to get the categoryName
...
function saveEdit(event) {
    ...
    // use dataset['id'] to get the value of the attribute dadata-id
...
function startDelete(event) {
    // Open modal to ask if the user is sure
